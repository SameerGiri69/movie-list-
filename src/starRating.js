    ...
    <div style={containerStyle}>
      <div style={starContainerStyle}>
        {Array.from({ length: 10 }, (_, i) => (
          // full = sends a boolean for each "star" to Star component. if the rating entered is greater than
          // current index then it returns true
          <Star
            key={i}
      ...
      <p style={textStyle}>{rating >= tempRating ? rating : tempRating}</p>
    </div>
  );
}
